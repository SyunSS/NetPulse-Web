...
<style scoped>
.toolbar { background:var(--panel-soft); }
.plan-card { background:var(--panel-gradient); }
.plan-schedule { background:var(--panel-tint); }
@media (max-width:760px) { .plan-grid { grid-template-columns:1fr; }.plan-card { padding:16px; }.plan-actions { flex-wrap:wrap; }.action-btn { flex:1 1 calc(50% - 6px); min-width:0; }.action-btn.primary { flex-basis:100%; }.action-btn.danger { flex:1 1 40px; }.toolbar { position:sticky; top:64px; z-index:5; } }
</style>
