...
<style scoped>
.task-detail { max-width:1400px; }.detail-header { padding-bottom:18px; border-bottom:1px solid var(--border-color); }.page-title { color:var(--text-primary); font-family:var(--font-display); font-weight:500; letter-spacing:-.05em; }.back-btn,.btn { border-color:var(--border-color); border-radius:5px; background:var(--bg-card); color:var(--text-secondary); font-family:var(--font-mono); font-size:10px; }.back-btn:hover,.btn:hover { border-color:var(--border-color-hover); background:var(--bg-hover); }.btn.primary { border-color:var(--color-primary); background:var(--color-primary); color:#06201f; }.btn.primary:hover { background:var(--color-primary-active); }.btn.warning { background:var(--color-warning); color:#291b08; }.btn.danger { border-color:var(--color-danger); background:var(--color-danger); color:#27120d; }.card,.info-card { border-color:var(--border-color); border-radius:10px; background:linear-gradient(145deg,var(--bg-card),rgba(15,32,50,.76)); box-shadow:var(--shadow-card); }.card-title { color:var(--text-primary); font-family:var(--font-display); font-size:16px; letter-spacing:-.03em; }.info-item { border:1px solid var(--border-color); background:var(--bg-alt); }.info-item code { color:var(--color-primary); }.progress-bar { background:rgba(136,169,201,.12); }.progress-fill { background:var(--color-primary); box-shadow:0 0 10px rgba(97,231,210,.5); }.log-box,.log-list { border:1px solid var(--border-color); background:#07111d; }.log-line,.log-msg { color:#9bb0c2; }.table-wrap { border:1px solid var(--border-color); border-radius:7px; }.dt th { background:var(--bg-elevated); color:var(--text-tertiary); font-family:var(--font-mono); font-size:9px; letter-spacing:.04em; text-transform:uppercase; }.dt td { color:var(--text-secondary); border-bottom-color:var(--border-color); }.dt tr:hover td { background:var(--bg-hover); }.badge.ok { background:var(--color-primary-bg); color:var(--color-primary); }.badge.err { background:rgba(255,138,101,.12); color:var(--color-danger); }.st-completed { background:var(--color-primary-bg); color:var(--color-primary); }.st-running { background:rgba(136,169,255,.12); color:var(--color-info); }.st-failed { background:rgba(255,138,101,.12); color:var(--color-danger); }.st-pending,.st-cancelled { background:rgba(155,176,194,.1); color:var(--text-secondary); }.empty { border-style:dashed; }.log-section { border-top:2px solid var(--color-primary); }.log-time,.log-level { color:var(--text-tertiary); font-family:var(--font-mono); font-size:10px; }.log-level { color:var(--color-primary); }
@media (max-width:700px) { .detail-header { gap:15px; flex-direction:column; }.header-actions { width:100%; }.header-actions .btn { flex:1; }.info-grid { grid-template-columns:1fr; }.dt { min-width:900px; }.table-wrap { overflow-x:auto; } }
</style>

<style scoped>
.card,.info-card { background:var(--panel-gradient); }
.log-box,.log-list { background:var(--bg-alt); }
.log-line,.log-msg { color:var(--text-secondary); }
@media (max-width:760px) { .task-detail { max-width:none; }.detail-header { align-items:stretch; }.header-actions { display:grid; grid-template-columns:1fr 1fr; }.header-actions > div { display:grid !important; grid-template-columns:repeat(3,1fr); grid-column:1 / -1; }.btn,.back-btn { min-height:36px; }.card,.info-card { padding:16px; }.page-title { font-size:26px; }.dt { min-width:760px; }.url-cell { max-width:180px; } }
@media (max-width:430px) { .header-actions { grid-template-columns:1fr; }.header-actions > div { grid-template-columns:1fr; }.dt { min-width:680px; } }
</style>
