...
<style scoped>
.plan-edit-page { max-width:1200px; }.page-title { color:var(--text-primary); font-family:var(--font-display); font-weight:500; letter-spacing:-.05em; }.back-btn,.action-btn,.form-input,.type-select,.cron-tab,.cron-preset { border-color:var(--border-color); border-radius:5px; background:var(--bg-card); color:var(--text-secondary); }.back-btn:hover,.action-btn:hover { border-color:var(--border-color-hover); background:var(--bg-hover); }.action-btn { font-family:var(--font-mono); font-size:10px; }.action-btn.primary,.add-item-btn { border-color:var(--color-primary); background:var(--color-primary); color:#06201f; }.action-btn.primary:hover,.add-item-btn:hover { background:var(--color-primary-active); }.form-container { gap:12px; }.form-section,.item-card { border-color:var(--border-color); border-radius:10px; background:linear-gradient(145deg,var(--bg-card),rgba(15,32,50,.76)); box-shadow:var(--shadow-card); }.section-title { color:var(--text-primary); font-family:var(--font-display); letter-spacing:-.03em; }.form-label { color:var(--text-secondary); font-family:var(--font-mono); font-size:10px; }.form-input,.type-select { background:var(--bg-input); }.form-input:focus,.type-select:focus { border-color:var(--color-primary); box-shadow:0 0 0 3px var(--color-primary-bg); }.cron-tabs { border-bottom-color:var(--border-color); }.cron-tab.active,.cron-preset.active { border-color:var(--border-bright); background:var(--color-primary-bg); color:var(--color-primary); }.preset-dot { background:var(--color-primary); }.cron-hint,.next-run-preview { border-color:var(--border-color); background:var(--bg-alt); color:var(--text-secondary); }.cron-hint code { color:var(--color-primary); }.item-header,.url-row { border-color:var(--border-color); }.empty-items { border-color:var(--border-color); color:var(--text-tertiary); }.remove-item-btn { color:var(--color-danger); }.switch input:checked + .slider { background:var(--color-primary); }
@media (max-width:650px) { .page-header { align-items:stretch; gap:14px; flex-direction:column; }.header-actions { width:100%; }.header-actions .action-btn { flex:1; }.form-row { align-items:stretch; flex-direction:column; }.section-header { align-items:flex-start; gap:12px; flex-direction:column; }.section-header > div { width:100%; }.cron-grid { grid-template-columns:1fr; } }
</style>

<style scoped>
.form-section,.item-card { background:var(--panel-gradient); }
@media (max-width:760px) { .plan-edit-page { max-width:none; }.page-header { align-items:stretch; }.header-actions { display:grid; grid-template-columns:1fr 1fr; }.form-section,.item-card { padding:16px; }.section-header > div { display:grid !important; grid-template-columns:1fr 1fr; gap:8px; }.section-header > div .add-item-btn { grid-column:1 / -1; }.url-row { align-items:stretch; flex-direction:column; }.url-row .form-input { width:100%; }.remove-url-btn { width:100%; } }
@media (max-width:430px) { .header-actions,.section-header > div { grid-template-columns:1fr; }.section-header > div .add-item-btn { grid-column:auto; } }
</style>
