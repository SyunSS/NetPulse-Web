...
<style scoped>
.settings-section { background:var(--panel-gradient); }
@media (max-width:760px) { .settings-page { max-width:none; }.settings-section { padding:18px; }.section-header { align-items:flex-start; gap:12px; flex-direction:column; }.setting-row,.info-item,.user-row { align-items:flex-start; gap:12px; flex-direction:column; }.user-actions,.cookie-actions,.cookie-row-actions { width:100%; }.role-select,.refresh-btn,.file-btn,.danger-btn { min-height:36px; }.user-actions { display:grid; grid-template-columns:1fr auto; }.cookie-actions { display:grid; grid-template-columns:1fr; }.cookie-row { align-items:flex-start; flex-direction:column; }.cookie-row-actions { display:grid; grid-template-columns:1fr 1fr; } }
</style>
